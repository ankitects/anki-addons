        ...
        for node in expr.split(" "):
            ...
            if not placeL:
                if not placeR:
                    ...
                    out.append(
                        f" {kanji[:-placeR]}[{reading[:-placeR]}]{reading[-placeR:]}"
                    )
            else:
                if not placeR:
                    out.append(
                        f"{reading[:placeL]} {kanji[placeL:]}[{reading[placeL:]}]"
                    )
                else:
                    out.append(
                        f"{reading[:placeL]} {kanji[placeL:-placeR]}[{reading[placeL:-placeR]}]{reading[-placeR:]}"
                    )
        fin = ""
